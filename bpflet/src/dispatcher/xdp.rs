...
impl XdpDispatcher {
    ...
    ) -> Result<XdpDispatcher, BpfletError> {
    ...
    pub(crate) fn attach(&mut self) -> Result<(), BpfletError> {
        debug!(
    ...
    pub(crate) fn delete(&self, full: bool) -> Result<(), BpfletError> {
        debug!(
