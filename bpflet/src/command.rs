...
impl ProgramData {
    ...
    fn get(&self, key: &str) -> Result<Vec<u8>, BpfletError> {
    ...
    fn get_option(&self, key: &str) -> Result<Option<sled::IVec>, BpfletError> {
    ...
    fn insert(&self, key: &str, value: &[u8]) -> Result<(), BpfletError> {
    ...
    fn get_kind(&self) -> Result<Option<ProgramType>, BpfletError> {
